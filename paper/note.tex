...
$\langle n,m\rangle:=\iint_{\mathbb R^3\times\mathbb R^}\frac{n(r)m(r')}{|r -
...
symmetry, all orbital components belonging to the same type will be contracted. This
yields the contraction matrix $M$. Additionally,
we eliminate orbital products not centered on atoms, using a restriction matrix. Then we apply PCD to this
matrix using the machine epsilon as a target tolerance value. This gives a set
of indices sorted in pivot-descensing order. The AO product
